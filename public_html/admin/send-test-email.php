...
<body style='font-family:Arial,sans-serif;color:#111;'>
  <div style='max-width:560px;margin:0 auto;border:1px solid #e8e8e8;border-radius:2px;overflow:hidden;'>
    <div style='background:#00BF63;padding:22px 28px;'>
    ...
    <div style='padding:24px 28px;'>
      ...
      <p style='color:#6b6b6b;font-size:13px;'>Sent at: " . date('Y-m-d H:i:s') . "<br>
