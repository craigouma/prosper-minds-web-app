...
8. **Sponsorship page** — the B2G partnership pitch described in Section 3: value proposition, the three eligible events, the four-tier package matrix (Platinum/Gold/Silver/Bronze) plus the specialised $1,000 packages and $500 add-ons, and the enquiry form. Real, existing content — carry the confident/bold energy of the current version into the new light-theme system, don't water it down to match the more generic homepage.
